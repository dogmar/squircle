...
corrPath.style.stroke = "var(--color-adjusted-border)";
...
const corrDotTop = makeRingDot("--color-adjusted-border", 12, 1);
const corrDotRight = makeRingDot("--color-adjusted-border", 12, 1);
